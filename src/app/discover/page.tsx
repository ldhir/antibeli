          ...
          <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="px-5 py-2.5 bg-white hover:bg-[#003314] hover:text-white text-[#666666] text-sm rounded-full border border-[#003314]/20 transition-all duration-300 disabled:opacity-50 hover:shadow-lg hover:shadow-[#003314]/20"
                    style={{ fontFamily: "var(--font-accent)" }}
                  >
                    {dish}
                  </button>
            ...
            {mealQueue.filter(m => !m.isCooked).length > 0 && (
              <div className="mt-12 text-center">
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 text-[#003314] hover:text-[#004d1f] font-medium"
                  style={{ fontFamily: "var(--font-accent)" }}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-pulse text-[#003314]">Loading...</div>
      </div>
    }>
      <DiscoverContent />
    </Suspense>
